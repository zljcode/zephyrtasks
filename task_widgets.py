...
class TaskRowWidget(QWidget):
    ...
    def __init__(self, task_id, title, completed, created_at=None, parent=None):
        ...
        self._edit_input.setStyleSheet(
            ...
            f'font: bold {self._BASE_FONT_SIZE}px "幼圆", "YouYuan", "Segoe UI", sans-serif;'
        )
    ...
    def set_scale(self, scale):
        ...
        self._edit_input.setStyleSheet(
            'background: rgba(232, 224, 213, 0.06); color: #E8E0D5; border: 1px solid #C9A96E; '
            'border-radius: 4px; padding: 2px 6px; '
            f'font: bold {edit_fs}px "幼圆", "YouYuan", "Segoe UI", sans-serif;'
        )
...
class InlineInput(QLineEdit):
    ...
    def _apply_style(self):
        self.setStyleSheet(
            ...
            f'font: bold {self._current_font_size}px "幼圆", "YouYuan", "Segoe UI", sans-serif; '
            f'padding: 0 12px;'
        )
